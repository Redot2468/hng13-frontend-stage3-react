...
import { addOrderAction } from "@/app/_lib/actions/order-action";
import { onToggleSuccessModal } from "@/app/_lib/redux/cartSlice";
...
export default function Checkout() {
  ...
  function onSubmitForm(values: CheckoutSchemaType) {
    startTransition(async () => {
      const res = await addOrderAction(values);
  ...
  return (
    <div className="bg-white-2">
      <div className="mx-auto max-w-[612px] space-y-6 px-6 py-12 lg:max-w-[1100px] lg:space-y-9 lg:py-16">
        ...
        >
          <div className="rounded-xl bg-white px-8 py-10 lg:w-[65%] lg:px-10 lg:py-12">
